...
// URL base da API - agora relativa (funciona com pfSense redirect ou ngrok)
const API_BASE_URL = '';  // deixe vazio para relativo (/api/...) ou coloque 'https://45.176.107.235' se preferir absoluto
...
window.addEventListener('load', async () => {
    ...
    if (location.protocol !== 'https:' && location.hostname !== 'localhost' && location.hostname !== '127.0.0.1') {
        ...
        alert("Atenção: Para parear dispositivos Bluetooth, acesse via HTTPS (ex: ngrok ou pfSense com certificado).");
    }
